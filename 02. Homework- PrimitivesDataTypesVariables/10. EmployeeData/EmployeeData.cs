...
class EmplyeeData
{
    static void Main()
    {
        ...
        Console.WriteLine("Personal ID number: {0}\t | type: {1}", personalID, personalID.GetTypeCode());
        Console.WriteLine("Employee number: {0}\t | type: {1}", employeeNumber, employeeNumber.GetTypeCode());
